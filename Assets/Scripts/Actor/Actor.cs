...
public class Actor : BaseObject
{
    ...
    public override void ThrowEvent(string keyData, params object[] datas)
    {
        if (keyData.Equals(ConstValue.EventKey_Hit))
        {
            ...
            // 카드레벨 공격력
            //GameObject actor = datas[2] as GameObject;
            //float levelDamage = 1 + actor.GetComponent<Actor>().cardLevel * 0.1f;
            //double attackDamage = casterCharacter.CHARACTER_STATUS.GetStatusData(eStatusData.ATTACK) * levelDamage;
