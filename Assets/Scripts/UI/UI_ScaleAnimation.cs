...
public class UI_ScaleAnimation : MonoBehaviour
{
	...
	public Transform TransformTo = null;
	...
	void init()
	{
		...
		TweenTransform tweenTransform = TweenTransform.Begin(gameObject, duration, TransformTo);
		tweenTransform.duration = duration;
		tweenTransform.delay = startDelay;
		tweenTransform.animationCurve = animationCurve;
